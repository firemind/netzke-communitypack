{
  ...
  initComponent: function(){
    ...
    M.Title.name = 'title';
    M.EventId.mapping = 'id';
    M.EventId.name = 'id';
    M.CalendarId =  {name: 'cid', mapping: 'cid', type: 'string'};
    Extensible.calendar.data.EventModel.reconfigure();

    var CM = Extensible.calendar.data.CalendarMappings;
    CM.CalendarId = {name: 'cid', mapping: 'cid', type: 'string'};
    CM.Title = {name: 'title', mapping: 'title', type: 'string'};
    CM.ColorId = {name: 'colorid', mapping: 'colorid', type: 'string'};
    ...
    var cal_proxy = {
      type: 'direct',
      directFn: Netzke.providers[this.id].getCalendarData,
      reader: {
        type: 'array',
        root: 'data',
    ...
    this.calendarStore = Ext.create('Extensible.calendar.data.MemoryCalendarStore', {
      //model: this.id,
      proxy: cal_proxy,
    data: this.inlineCalendarData && [this.inlineCalendarData.data] || [], 
    fields: Extensible.calendar.data.CalendarModel.prototype.fields.getRange()
    });
